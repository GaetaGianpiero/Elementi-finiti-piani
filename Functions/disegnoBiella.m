%DISEGNOBIELLA(P,s,d,grandezza) disegna un elemento finito di biella:
...
% Versione: 1.0
function[]=disegnoBiella(P,s,d,grandezza)
% P=posizione dei due punti -> Matrice [xa,ya;xb,yb]
% s=lettera a sinistra
% d= lettera a destra
line([P(1,1) P(2,1)],[P(1,2) P(2,2)],[0,0],'Color','k','LineWidth',1);
